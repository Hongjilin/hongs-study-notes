...
> 2. 每个知识点笔记中的 [ `README.md` ] 为截取当前知识点体系的部分笔记, 方便网站阅读
> 3. 每个知识点笔记都会在上方 [ `说明` ] 部分给出借阅的资料、出处、或者看的教程视频, 方便同学们找到对应学习资料
> 4. `建议下载后用 Typora 进行阅读` :
>    -  首先排版样式会相对友好(本人使用此软件撰写笔记);
>    - 其次有的笔记体积大(部分笔记有大量示例图), `网站打开速度慢`; 所以当你点进去某个知识点笔记中响应时间久,说明我截取的知识点笔记内容多

...
>
> 只截取了上方`ES系列知识补充与应用实践`部分笔记的部分知识点至此,方便网站阅读
...
>
>本人笔记地址分享:[全部笔记](https://gitee.com/hongjilin/hongs-study-notes)、**[ES6及后续版本学习笔记](https://gitee.com/hongjilin/hongs-study-notes/tree/master/编程_前端开发学习笔记/ES6及后续版本学习笔记)**、**[ES6资料文档摘录](https://gitee.com/hongjilin/hongs-study-notes/tree/master/编程_前端开发学习笔记/ES6及后续版本学习笔记/ES6资料文档摘录)** 

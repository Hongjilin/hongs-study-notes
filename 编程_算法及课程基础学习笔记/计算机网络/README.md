...
>
> 只截取了上方`浅学Http协议底层原理及浏览器工作流程笔记`笔记的部分知识点至此,方便网站阅读
>
> 更多知识点请看`同级笔记目录其他文件`
...
>•合成之后，再绘制到界面上。
>
>![该图来自视频课程截图](浅学Http协议底层原理及浏览器工作流程笔记中的图片/image-20210621175650437.png) 
...
> ![image-20210622195949961](浅学Http协议底层原理及浏览器工作流程笔记中的图片/image-20210622195949961.png) 
...
>![image-20210622202103234](浅学Http协议底层原理及浏览器工作流程笔记中的图片/image-20210622202103234.png) 

#### ② *Response Header*

>![image-20210622202158322](浅学Http协议底层原理及浏览器工作流程笔记中的图片/image-20210622202158322.png) 
...
>![](浅学Http协议底层原理及浏览器工作流程笔记中的图片/image-20210622203341816.png) 
